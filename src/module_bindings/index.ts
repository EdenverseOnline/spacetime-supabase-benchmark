...
export { SeedBenchmarkGearDefsReducer };
import UpdateBenchmarkAvatarGearReducer from "./update_benchmark_avatar_gear_reducer";
export { UpdateBenchmarkAvatarGearReducer };

// Import and reexport all procedure arg types

// Import and reexport all table handle types
import BenchmarkAvatarConfigRow from "./benchmark_avatar_config_table";
export { BenchmarkAvatarConfigRow };
import BenchmarkGearDefRow from "./benchmark_gear_def_table";
export { BenchmarkGearDefRow };

// Import and reexport all types
import BenchmarkAvatarConfig from "./benchmark_avatar_config_type";
export { BenchmarkAvatarConfig };
import BenchmarkGearDef from "./benchmark_gear_def_type";
export { BenchmarkGearDef };

/** The schema information for all tables in this module. This is defined the same was as the tables would have been defined in the server. */
const tablesSchema = __schema(
  __table(
    {
      name: "benchmark_avatar_config",
      indexes: [
        {
          name: "wallet_address",
          algorithm: "btree",
      ...
      constraints: [
        {
          name: "benchmark_avatar_config_wallet_address_key",
          constraint: "unique",
          columns: ["walletAddress"],
        },
      ],
    },
    BenchmarkAvatarConfigRow,
  ),
  __table(
    {
      name: "benchmark_gear_def",
      indexes: [{ name: "id", algorithm: "btree", columns: ["id"] }],
      constraints: [
        {
          name: "benchmark_gear_def_id_key",
          constraint: "unique",
          columns: ["id"],
        },
      ],
...
const reducersSchema = __reducers(
  __reducerSchema("seed_benchmark_gear_defs", SeedBenchmarkGearDefsReducer),
  __reducerSchema(
    "update_benchmark_avatar_gear",
    UpdateBenchmarkAvatarGearReducer,
  ),
);
