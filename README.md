...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/SpacetimeDB-1.11.1-10b981?style=for-the-badge" alt="SpacetimeDB" />
...
A standalone React benchmark application that measures real CRUD operation latencies against **SpacetimeDB** (WebSocket + WASM) and **Supabase** (PostgreSQL + REST API) side by side. Built as part of the [Edenverse Online](https://github.com/edenverse) game project to scientifically validate our decision to migrate from traditional REST/Postgres to SpacetimeDB.
...
| :---------- | :----------------------------- | :---------------------------- |
| Frontend    | React 19.2 + TypeScript 5.9    | Benchmark UI                  |
| Bundler     | Vite 7.3                       | Dev server and builds         |
| Charts      | Recharts 3.7                   | Latency and throughput graphs |
| Icons       | react-icons 5.6                | UI iconography                |
| Validation  | Zod 4.3                        | Schema validation             |
| Backend A   | SpacetimeDB 1.11.1 (Rust WASM) | WebSocket real-time DB        |
| Backend B   | Supabase 2.98 (PostgreSQL)     | REST API database             |
| Schema Mgmt | Drizzle ORM 0.45 + Drizzle Kit | Supabase migrations           |
